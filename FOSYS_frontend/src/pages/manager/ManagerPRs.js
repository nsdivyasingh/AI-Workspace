...
const ManagerPRs = ({ user }) => {
  ...
  return (
    <div className="p-8" data-testid="manager-prs-page">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-white mb-4" style={{fontFamily: 'Work Sans'}}>Pull Requests</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredProjects.map((project) => (
          <button
            ...
            onClick={() => navigate(`/dashboard/manager/prs/${project.id}`)}
